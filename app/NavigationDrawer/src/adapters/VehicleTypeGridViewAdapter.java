 ...
 */
public class VehicleTypeGridViewAdapter extends BaseAdapter {
    ...
    public VehicleTypeGridViewAdapter(Context context, String[] mResourcesDescription, String[] mResourcesImages, TypedArray images) {
