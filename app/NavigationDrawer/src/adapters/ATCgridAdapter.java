 ...
 */
public class ATCgridAdapter extends BaseAdapter {
    ...
    public ATCgridAdapter(Context context, String[] mResourcesDescription, String[] mResourcesImages, TypedArray images) {
