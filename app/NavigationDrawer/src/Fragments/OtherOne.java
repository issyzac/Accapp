    ...
    public void init() {
        ...
        ViewName.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                Passenger.NameD=ViewName.getText().toString();
        ...
        ViewDateOfBirth.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.DateOfBirthD=ViewDateOfBirth.getText().toString();
        ...
        ViewAddress.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.AddressD=ViewAddress.getText().toString();
        ...
        ViewPhysicalAddress.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.PhysicalAddressD=ViewPhysicalAddress.getText().toString();
        ...
        ViewNationalId.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.NationalIdD=ViewNationalId.getText().toString();
        ...
        ViewPhoneNo.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.PhoneNoD=ViewPhoneNo.getText().toString();
        ...
        ViewDrugsAlcohol.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.drugsD=ViewDrugsAlcohol.getText().toString();
