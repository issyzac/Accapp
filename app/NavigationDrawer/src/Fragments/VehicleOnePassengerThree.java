    ...
    public void init() {
        ...
        ViewName.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                Passenger.Name13=ViewName.getText().toString();
        ...
        ViewDateOfBirth.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.DateOfBirth13=ViewDateOfBirth.getText().toString();
        ...
        ViewAddress.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.Address13=ViewAddress.getText().toString();
        ...
        ViewPhysicalAddress.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.PhysicalAddress13=ViewPhysicalAddress.getText().toString();
        ...
        ViewNationalId.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.NationalId13=ViewNationalId.getText().toString();
        ...
        ViewPhoneNo.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.PhoneNo13=ViewPhoneNo.getText().toString();
        ...
        ViewDrugsAlcohol.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.drugs13=ViewDrugsAlcohol.getText().toString();
