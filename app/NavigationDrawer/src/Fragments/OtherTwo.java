    ...
    public void init() {
        ...
        ViewName.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                Passenger.NameE=ViewName.getText().toString();
        ...
        ViewDateOfBirth.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.DateOfBirthE=ViewDateOfBirth.getText().toString();
        ...
        ViewAddress.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.AddressE=ViewAddress.getText().toString();
        ...
        ViewPhysicalAddress.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.PhysicalAddressE=ViewPhysicalAddress.getText().toString();
        ...
        ViewNationalId.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.NationalIdE=ViewNationalId.getText().toString();
        ...
        ViewPhoneNo.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.PhoneNoE=ViewPhoneNo.getText().toString();
        ...
        ViewDrugsAlcohol.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.drugsE=ViewDrugsAlcohol.getText().toString();
