...
public class VehicleOnePassengerTwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = (ViewGroup) inflater.inflate(
                R.layout.one_pass_two, container, false);
    ...
    public void init() {
        ...
        ViewName.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                Passenger.Name12=ViewName.getText().toString();
        ...
        ViewDateOfBirth.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.DateOfBirth12=ViewDateOfBirth.getText().toString();
        ...
        ViewAddress.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.Address12=ViewAddress.getText().toString();
        ...
        ViewPhysicalAddress.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.PhysicalAddress12=ViewPhysicalAddress.getText().toString();
        ...
        ViewNationalId.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.NationalId12=ViewNationalId.getText().toString();
        ...
        ViewPhoneNo.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.PhoneNo12=ViewPhoneNo.getText().toString();
        ...
        ViewDrugsAlcohol.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.drugs12=ViewDrugsAlcohol.getText().toString();
        ...
        ViewSeatbeltHelmet.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void afterTextChanged(Editable editable) {
                Passenger.SeatbeltHelmet12=ViewSeatbeltHelmet.getText().toString();
